...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "agpjza5q5cs9Zz0onK90uJrf8Dd9mRGJM-b8Bfxr";
    private static final String SECRETKEY = "ya2H3JpcKgAe2Ev8XjVwxzNQhjdbZ91YOlK3CiEm";
    private static final String BUCKET = "sz-106";
    public static final String DOMAIN= "http://qmlyvnsjs.hn-bkt.clouddn.com/";
